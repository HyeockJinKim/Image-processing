function edge_image = my_canny_edge2(img, filter_size)
% Find edge of Image using canny edge detection with Otsu
...
% Calculate High Threshold, Low Threshold
high_th = my_threshold(uint8(magnitude), 'between');
low_th = 0.4 * high_th;
